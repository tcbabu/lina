...
*/
  ...
  int PdDiaGroup ( DIALOG *D , void **v , void *pt ) {
      ...
      xpm0 = ( char * ) MakePixmapImage ( 266 , 96 , lc.Red , lc.Green , lc.Blue , lc.fac ) ;
          
      DIP p0 = {
          'p' , 2 , 2 , 268 , 98 , ( void * ) xpm0 , -1 , /* bkgr colour */
          3 , 0 , 0.08 /* border hide */
      };
...
*************************************************/
  ...
  int PdDia ( void *parent , void **v , void *pt ) {
      ...
      D.lw = 4;
      D.rw = 4;
      D.xo = 466; /* Position of Dialog */
      D.yo = 340;
      D.xl = 270; /* Length of Dialog */
      D.yl = 100; /* Width of Dialog */
      D.Initfun = PdDiainit; /* init fuction for Dialog */
      D.Cleanupfun = PdDiacleanup; /* init fuction for Dialog */
      ...
      D.MinWidth = 40; /* for Resize option */
      D.MinHeight = 40; /* for Resize option */
#if 1 
      D.Callback = PdDiaCallBack; /* default callback */
#else 
      D.Callback = NULL;
#endif
      D.ResizeCallback = PdDiaResizeCallBack; /* Resize callback */
#if 1 
      D.WaitCallback = NULL; /* Wait callback */
#else 
      D.WaitCallback = PdDiaWaitCallBack; /* Wait callback */
#endif
