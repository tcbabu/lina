...
*/
  ...
  int UserDiaGroup_o ( DIALOG *D , void **v , void *pt ) {
      ...
      DIA *d = NULL , *dtmp;
      DIX x0 = {
          'x' , 4 , 5 , 215 , 246 , 10 , 2 , 112 , 48 , 1 , 1 , 0 , 4 , ( int * ) v [ 0 ] , NULL , NULL , NULL , UserDiabrowser1callback , /* *args , callback */
          6 , /* Border Offset */
          18 , /* Scroll width */
          12 , /* Type */
          1 , /* item highlight */
...
//  xpm0 = (char *)MakePixmapImage( 210,242,lc.Red,lc.Green,lc.Blue,lc.fac);
      xpm0 = ( char * ) MakePixmapImage ( 210 , 242 , lc.Red , lc.Green , lc.Blue , 0.05 ) ;
          
      DIP p0 = {
          'p' , 3 , 4 , 217 , 246 , ( void * ) xpm0 , -1 , /* bkgr colour */
          3 , 0 , 0.1 /* border hide */
      };
      strcpy ( p0.Wid , ( char * ) "UserDiaWidget2" ) ;
      DIX x1 = {
          'x' , 12 , 13 , 206 , 236 , 10 , 2 , 112 , 48 , 1 , 18254608 , 0 , 4 , 
              ( int * ) v [ 0 ] , NULL , NULL , NULL , UserDiabrowser1callback , /* *args , callback */
          6 , /* Border Offset */
          18 , /* Scroll width */
          12 , /* Type */
          1 , /* item highlight */
...
*************************************************/
  ...
  int UserDia ( void *parent , void **v , void *pt ) {
      ...
      D.yo = 218;
      D.xl = 219; /* Length of Dialog */
      D.yl = 251; /* Width of Dialog */
      D.Initfun = UserDiainit; /* init fuction for Dialog */
      D.Cleanupfun = UserDiacleanup; /* init fuction for Dialog */
...
#if 1 
      D.Callback = UserDiaCallBack; /* default callback */
#else 
      D.Callback = NULL;
#endif
      D.ResizeCallback = UserDiaResizeCallBack; /* Resize callback */
#if 1 
      D.WaitCallback = NULL; /* Wait callback */
#else 
      D.WaitCallback = UserDiaWaitCallBack; /* Wait callback */
#endif
