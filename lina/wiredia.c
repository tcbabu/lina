...
*/
  ...
  int wirediaGroup ( DIALOG *D , void **v , void *pt ) {
      ...
      DIP p0 = {
      'p' , 5 , 5 , 357 , 355 , ( void * ) xpm0 , -1 , /* bkgr colour */ 3 , 0 , 0.1 /* border hide */ };
      ...
      'n' , 77 , 276 , 283 , 310 , 2 , 2 , 64 , 24 , 3 , 1 , 2 , 0.500000 , 0 , 0 , 0 , 1 , /* button type and roundinfg factor 
          ( 0-0.5 ) , bordr , hide , nodrawbkgr*/ butn2 , wirediabutton1callback , /* Callbak */ NULL /* any args */ };
      ...
      'h' , 102 , 312 , 258 , 345 , 2 , 0 , 72 , 25 , 2 , 1 , 5 , 0.500000 , 0 , 0 , 0 , 1 , /* button type and roundinfg factor 
          ( 0-0.5 ) , bordr , hide , nodrawbkgr*/ butn3 , wirediasplbutton1callback , /* Callbak */ NULL /* any args */ };
      ...
      'h' , 102 , 311 , 258 , 344 , 2 , 0 , 72 , 25 , 2 , 1 , 5 , 0.500000 , 0 , 0 , 0 , 1 , /* button type and roundinfg factor 
          ( 0-0.5 ) , bordr , hide , nodrawbkgr*/ butn4 , wirediasplbutton2callback , /* Callbak */ NULL /* any args */ };
          
      strcpy ( h4.Wid , ( char * ) "wirediaWidget5" ) ;
      DIX x5 = {
      'x' , 20 , 20 , 342 , 220 , 10 , 2 , 299 , 40 , 1 , 2 , 0 , 4 , ( int * ) v [ 0 ] , NULL , NULL , NULL , wirediabrowser1callback , /* *args , callback */ 6 , /* Border Offset */ 22 , /* Scroll width */ 11 , /* Type */ 1 , /* item highlight */ 0 , /* bordr */ 0 , /* bkgr */ 0 /*= 1 hide */ };
...
*************************************************/
      ...
      *v0 = 1;
      ...
      v [ 1 ] = NULL;
      v [ 0 ] = ( void * ) ( v0 ) ;
      void *pt = NULL; /* pointer to send any extra information */ GrpId = wirediaGroup 
          ( D , v , pt ) ;
  ...
  int wiredia ( void *parent , void **v , void *pt ) {
      ...
      D.lw = 4;
      D.rw = 4;
      D.xo = 522; /* Position of Dialog */ D.yo = 132;
#if 1 
#else 
      D.xl = 360; /* Length of Dialog */ D.yl = 362; /* Width of Dialog */ D.Initfun = wirediainit;
           /* init fuction for Dialog */ D.Cleanupfun = wirediacleanup; /* init fuction for Dialog */ D.kbattn = 0;
           ...
           /* for Resize option */ D.MinHeight = 100; /* for Resize option */ D.Callback = wirediaCallBack;
...
//  strcpy(D.name,"Kulina Designer ver 1.0");    /*  Dialog name you may change */
      D.ResizeCallback = wirediaResizeCallBack; /* Resize callback */ D.WaitCallback = NULL;
           /* Wait callback */ D.WaitCallback = wirediaWaitCallBack; /* Wait callback */ D.Fixpos = 1;
...
//     D.StackPos = 1; // you may need it
      } /* end of fullscreen mode */ grp1 = kgOpenGrp ( & D ) ;
...
*************************************************/
      ...
      void* v [ 1 ] ;
      v [ 0 ] = ( void * ) ( & v0 ) ;
      void *pt = NULL; /* pointer to send any extra information */ ret = wiredia 
          ( arg , v , pt ) ;
      if ( ret == 1 ) ret = 0;
      else ret = 1;
      return RetVal;;
