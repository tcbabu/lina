...
//   kgChangeColor(fid,253,(int)bred/3,(int)bgreen/3,(int)bblue/3);
      kgRoundedRectangleFill ( fid , ( float ) xl*0.5 , ( float ) yl*0.5 , 
          ( float ) xl , ( float ) yl , 0 , 253 , fac ) ;
      kgRoundedRectangleFill ( fid , ( float ) xl*0.5 , ( float ) yl*0.5 , 
          ( float ) xl-1 , ( float ) yl-1. , 0 , 252 , fac ) ;
      kgRoundedRectangleFill ( fid , ( float ) xl*0.5 , ( float ) yl*0.5 , 
          ( float ) xl-6 , ( float ) yl-6 , 0 , 251 , fac ) ;
      kgLineWidth ( fid , 4 ) ;
      kgLineColor ( fid , 252 ) ;
  ...
  void *MakePixmapImage ( int xl , int yl , int r , int g , int b , float fac ) 
      ...
      kgChangeColor ( fid , 253 , ( int ) rf , ( int ) gf , ( int ) bf ) ;
      kgRoundedRectangleFill ( fid , ( float ) xl*0.5 , ( float ) yl*0.5 , 
          ( float ) xl+1 , ( float ) yl+1 , 0 , 253 , fac ) ;
      kgRoundedRectangleFill ( fid , ( float ) xl*0.5 , ( float ) yl*0.5 , 
          ( float ) xl , ( float ) yl , 0 , 252 , fac ) ;
      kgRoundedRectangleFill ( fid , ( float ) xl*0.5 , ( float ) yl*0.5 , 
          ( float ) xl-4 , ( float ) yl-4 , 0 , 251 , fac ) ;
#if 1
