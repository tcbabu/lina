...
//  strcpy(xpm0, (char *)"##/root/lina/WRK/thara.png");
      xpm0 = imgs [ 0 ] ;
      DIP p0 = {
          'p' , 349 , 198 , 765 , 354 , ( void * ) xpm0 , 12 , /* bkgr colour */
          0 , 0 /* border hide */
           , 0.2 // transparency
      };
...
//    450,240,  
//    500,290,  
          'p' , 430 , 220 , 480 , 270 , ( void * ) xpm3 , -1 , /* bkgr colour */
          0 , 0 /* border hide */
       , 0.0 };
...
//  strcpy(xpm0,"##login.png");
      ...
      DIL h4 = {
          ...
          butn4 , linasplbutton1callback , /* Callbak */
          NULL /* any args */
      };
...
//    718,278,
          'n' , 480 , 231 , 700 , 266 , 2 , 2 , 200 , 24 , 1 , 1 , 10 , 0.2500000 , 0 , 0 , 0 , 1 , /* button type and roundinfg factor 
              ( 0-0.5 ) , bordr , hide , nodrawbkgr*/
          butn5 , linabutton1callback , /* Callbak */
          NULL /* any args */
      };
...
//  butn6[2].xpmn= (void *)&wireless1_str;
      ...
      DIL h6 = {
          'h' , 1142 , 590 , 1460 , 636 , 30 , 3 , 44 , 44 , 4 , 1 , 0 , 0.500000 , 0 , 0 , 0 , 1 , /* button type and roundinfg factor 
              ( 0-0.5 ) , bordr , hide , nodrawbkgr*/
          butn6 , linasplbutton2callback , /* Callbak */
          NULL /* any args */
      };
      ...
      DIP p7 = {
          'p' , 1000 , 20 , 1300 , 120 , ( void * ) xpm7 , 12 , /* bkgr colour */
          0 , 0 /* border hide */
       , 0.3 };
