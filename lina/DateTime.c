...
#include "headers.h"
  void * DateTimeImg ( LINACONFIG *lc , int xl , int yl ) {
...
#if 0
      char *Month [ ] = { ( char * ) "JAN" , ( char * ) "FEB" , ( char * ) "MAR" , 
          ( char * ) "APR" , ( char * ) "MAY" , ( char * ) "JUN" , ( char * ) "JUL" , 
          ( char * ) "AUG" , ( char * ) "SEP" , ( char * ) "OCT" , 
          ( char * ) "NOV" , ( char * ) "DEC"};
      char *Day [ ] = { ( char * ) "SUN" , ( char * ) "MON" , ( char * ) "TUE" , 
      ...
      char *Month [ ] = { ( char * ) "Jan" , ( char * ) "Feb" , ( char * ) "Mar" , 
          ...
          ( char * ) "Nov" , ( char * ) "Dec"};
#else
      char *Month [ ] = { ( char * ) "January" , ( char * ) "February" , ( char * ) "March  ! " , 
...
#else
          sprintf ( buf , "!y!h32%-2.2d:%-2.2d!h23!h25!w35%-s!w53!h52!k!x!x!x!h45 %-s!r!z23  %-2.2d %-s %4.4d" , Hour , Minute , AmPm [ Indx ] , Day [ dt-> tm_wday ] , dt-> tm_mday , Month [ dt-> tm_mon ] , dt-> tm_year+1900 ) ;
