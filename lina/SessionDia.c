...
*/
  ...
  int SessionDiaGroup ( DIALOG *D , void **v , void *pt ) {
      ...
      xpm0 = ( char * ) MakePixmapImage ( 162 , 161 , lc.Red , lc.Green , lc.Blue , 0.05 ) ;
          
      DIP p0 = {
          'p' , 1 , 2 , 169 , 168 , ( void * ) xpm0 , -1 , /* bkgr colour */
          3 , 0 , 0.1 /* border hide */
      };
      ...
      ThumbNail **th0 ;
      DIRA r1 = {
          'r' , 10 , 10 , 160 , 158 , 8 , 0 , 90 , 25 , 1 , 3 , 0 , 3 , ( int * ) v [ 0 ] , NULL , NULL , NULL , SessionDiabrowser1callback , /* *args , callback */
          4 , /* Border Offset */
          16 , /* Scroll width */
          0 , /* Type */
          0 , /* item highlight */
...
*************************************************/
  ...
  int SessionDia ( void *parent , void **v , void *pt ) {
      ...
      D.lw = 4;
      D.rw = 4;
      D.xo = 716; /* Position of Dialog */
      D.yo = 161;
      D.xl = 174; /* Length of Dialog */
      D.yl = 174; /* Width of Dialog */
      D.Initfun = SessionDiainit; /* init fuction for Dialog */
      D.Cleanupfun = SessionDiacleanup; /* init fuction for Dialog */
...
#if 1 
      D.Callback = SessionDiaCallBack; /* default callback */
#else 
      D.Callback = NULL;
#endif
      D.ResizeCallback = SessionDiaResizeCallBack; /* Resize callback */
#if 1 
      D.WaitCallback = NULL; /* Wait callback */
#else 
      D.WaitCallback = SessionDiaWaitCallBack; /* Wait callback */
#endif
