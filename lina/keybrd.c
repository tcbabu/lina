...
*/
  ...
  int keybrdGroup ( DIALOG *D , void **v , void *pt ) {
      ...
      DIP p0 = {
          'p' , 1 , 1 , 840 , 252 , ( void * ) xpm0 , -1 , /* bkgr colour */
          0 , 0 , 0.2 /* border hide */
      };
      ...
      DIN b1 = {
          ...
          butn1 , keybrdbutton1callback , /* Callbak */
          NULL /* any args */
      };
      ...
      DIN b2 = {
          'n' , 12 , 68 , 825 , 130 , 10 , 0 , 52 , 24 , 13 , 2 , 9 , 0.000000 , 0 , 0 , 0 , 1 , /* button type and roundinfg factor 
              ( 0-0.5 ) , bordr , hide , nodrawbkgr*/
          butn2 , keybrdbutton2callback , /* Callbak */
          NULL /* any args */
      };
      ...
      butn3 [ 0 ] .sw = 1;
      strcpy ( butn3 [ 0 ] .title , ( char * ) "Clear" ) ;
      butn3 [ 0 ] .xpmn = Bimgu;
      butn3 [ 0 ] .xpmp = NULL;
      butn3 [ 0 ] .xpmh = NULL;
      butn3 [ 0 ] .bkgr = -1;
      ...
      butn3 [ 12 ] .butncode = '
      butn3 [ 13 ] .sw = 1;
      strcpy ( butn3 [ 13 ] .title , ( char * ) "Escape" ) ;
      butn3 [ 13 ] .xpmn = Bimgu;
      butn3 [ 13 ] .xpmp = NULL;
      butn3 [ 13 ] .xpmh = NULL;
      butn3 [ 13 ] .bkgr = -1;
      ...
      butn3 [ 24 ] .butncode = '
      butn3 [ 25 ] .sw = 1;
      strcpy ( butn3 [ 25 ] .title , ( char * ) "Enter" ) ;
      butn3 [ 25 ] .xpmn = v [ 4 ] ;
      butn3 [ 25 ] .xpmp = NULL;
      butn3 [ 25 ] .xpmh = NULL;
      butn3 [ 25 ] .bkgr = -1;
      ...
      DIN b3 = {
          'n' , 12 , 128 , 825 , 190 , 10 , 0 , 52 , 24 , 13 , 2 , 9 , 0.000000 , 0 , 0 , 0 , 1 , /* button type and roundinfg factor 
              ( 0-0.5 ) , bordr , hide , nodrawbkgr*/
          butn3 , keybrdbutton3callback , /* Callbak */
          NULL /* any args */
      };
      ...
      butn4 [ 0 ] .sw = 1;
      strcpy ( butn4 [ 0 ] .title , ( char * ) "PgUp" ) ;
      butn4 [ 0 ] .xpmn = Bimgu;
      butn4 [ 0 ] .xpmp = NULL;
      butn4 [ 0 ] .xpmh = NULL;
      butn4 [ 0 ] .bkgr = -1;
      ...
      butn4 [ 7 ] .butncode = '
      butn4 [ 8 ] .sw = 1;
      strcpy ( butn4 [ 8 ] .title , ( char * ) "Insert" ) ;
      butn4 [ 8 ] .xpmn = Bimgu;
      butn4 [ 8 ] .xpmp = NULL;
      butn4 [ 8 ] .xpmh = NULL;
      butn4 [ 8 ] .bkgr = -1;
      ...
      butn4 [ 11 ] .butncode = '';
      butn4 [ 12 ] .sw = 1;
      strcpy ( butn4 [ 12 ] .title , ( char * ) "Home" ) ;
      butn4 [ 12 ] .xpmn = Bimgu;
      butn4 [ 12 ] .xpmp = NULL;
      butn4 [ 12 ] .xpmh = NULL;
      butn4 [ 12 ] .bkgr = -1;
      butn4 [ 12 ] .butncode = '
      butn4 [ 13 ] .sw = 1;
      strcpy ( butn4 [ 13 ] .title , ( char * ) "PgDown" ) ;
      butn4 [ 13 ] .xpmn = Bimgu;
      butn4 [ 13 ] .xpmp = NULL;
      butn4 [ 13 ] .xpmh = NULL;
      butn4 [ 13 ] .bkgr = -1;
      ...
      butn4 [ 20 ] .butncode = '
      butn4 [ 21 ] .sw = 1;
      strcpy ( butn4 [ 21 ] .title , ( char * ) "Space" ) ;
      butn4 [ 21 ] .xpmn = Bimgu;
      butn4 [ 21 ] .xpmp = NULL;
      butn4 [ 21 ] .xpmh = NULL;
      butn4 [ 21 ] .bkgr = -1;
      ...
      butn4 [ 23 ] .butncode = '
      butn4 [ 24 ] .sw = 1;
      strcpy ( butn4 [ 24 ] .title , ( char * ) "Del" ) ;
      butn4 [ 24 ] .xpmn = Bimgu;
      butn4 [ 24 ] .xpmp = NULL;
      butn4 [ 24 ] .xpmh = NULL;
      butn4 [ 24 ] .bkgr = -1;
      butn4 [ 24 ] .butncode = '
      butn4 [ 25 ] .sw = 1;
      strcpy ( butn4 [ 25 ] .title , ( char * ) "End" ) ;
      butn4 [ 25 ] .xpmn = Bimgu;
      butn4 [ 25 ] .xpmp = NULL;
      butn4 [ 25 ] .xpmh = NULL;
      butn4 [ 25 ] .bkgr = -1;
      ...
      DIN b4 = {
          'n' , 12 , 188 , 825 , 250 , 10 , 0 , 52 , 24 , 13 , 2 , 9 , 0.000000 , 0 , 0 , 0 , 1 , /* button type and roundinfg factor 
              ( 0-0.5 ) , bordr , hide , nodrawbkgr*/
          butn4 , keybrdbutton4callback , /* Callbak */
          NULL /* any args */
      };
