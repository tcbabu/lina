...
int lina( void *parent,void **v,void *pt) {
  ...
  Textgrp = kgOpenGrp(&D);
  kgAddtoGrp(&D,Textgrp,d[0].t);
  kgAddtoGrp(&D,Textgrp,d[1].t);
  kgAddtoGrp(&D,Textgrp,d[2].t);
  kgAddtoGrp(&D,Textgrp,d[3].t);
  kgAddtoGrp(&D,Textgrp,d[4].t);
  kgAddtoGrp(&D,Textgrp,d[5].t);
...
//     kgShiftGrp(&D,lc.KbGrp,(xres-840)/2-5,yres-305);
  ...
  wgrp =  MakewirediaGroup(&D,NULL);
  addnetgrp =  MakeaddnetdiaGroup(&D,NULL);
  pskgrp =  MakepskdiaGroup(&D,NULL);
  kgSetGrpVisibility((void *)&D,wgrp,0);
  kgSetGrpVisibility((void *)&D,addnetgrp,0);
  kgSetGrpVisibility((void *)&D,pskgrp,0);
...
#endif
  kgSetKeybrdWidget(1);
  kgShiftGrp(&D,wgrp,(xres-362)/2,(yres/2-250));
  kgShiftGrp(&D,addnetgrp,(xres-389)/2,(yres-134)/2);
  kgShiftGrp(&D,pskgrp,(xres-348)/2,(yres-82)/2);
#endif
